...
/* Falling snowflakes - 6 independent layers with prime-number timing */
    ...
    `}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={show_greeting:!0,icon_size:100,card_height:"auto",sun_entity:"sun.sun",icon_position:"left",show_forecast:!1,forecast_days:5,show_sunrise_sunset:!1,show_alerts:!1,show_background_effects:!1,tap_action:{action:"more-info"},hold_action:{action:"none"},double_tap_action:{action:"none"},...t}}getCardSize(){return 3}getLayoutOptions(){return this._config?.view_layout||{}}static getConfigElement(){return document.createElement("weather-card-editor")}static getStubConfig(){return{type:"custom:weather-card",weather_entity:"weather.forecast_home",sun_entity:"sun.sun",primary_entity:"weather.forecast_home",primary_attribute:"temperature",primary_unit:"°F",secondary_entity:"weather.forecast_home",secondary_attribute:"apparent_temperature",secondary_unit:"°F",secondary_label:"Feels Like:",show_greeting:!0,icon_size:100,show_forecast:!0,forecast_days:5,show_sunrise_sunset:!0}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._handleTap),this.addEventListener("contextmenu",this._handleHold),this.addEventListener("touchstart",this._handleTouchStart,{passive:!0}),this.addEventListener("touchend",this._handleTouchEnd)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this._handleTap),this.removeEventListener("contextmenu",this._handleHold),this.removeEventListener("touchstart",this._handleTouchStart),this.removeEventListener("touchend",this._handleTouchEnd)}_executeAction(t){if(t&&"none"!==t.action)switch(t.action){case"more-info":const e=t.entity||this._config.weather_entity;if(e){const t=new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0});this.dispatchEvent(t)}break;case"navigate":if(t.navigation_path){history.pushState(null,"",t.navigation_path);const e=new CustomEvent("location-changed",{bubbles:!0,composed:!0});this.dispatchEvent(e)}break;case"url":t.url_path&&window.open(t.url_path,"_blank");break;case"call-service":if(t.service){const[e,i]=t.service.split(".");this.hass.callService(e,i,t.service_data||{})}}}render(){if(!this._config||!this.hass)return j``;const t=this._getGreeting(),e=this._getPrimaryValue(),i=this._getSecondaryValue(),r=this._getDescription(),s=!1!==this._config.show_greeting,a="right"===this._config.icon_position,n=this._config.weather_entity?this.hass.states[this._config.weather_entity]:void 0,o=this._config.sun_entity?this.hass.states[this._config.sun_entity]:void 0,l=n?.state||"",d="above_horizon"===o?.state,f=["weather-card-grid",s?"":"no-greeting",a?"icon-right":""].filter(Boolean).join(" ");return j`
      <ha-card style="height: ${this._config.card_height}">
        ...
        <div class="${f}" style="--weather-icon-size: ${this._config.icon_size}px">
          ${s?j`<div class="greeting">${t}</div>`:F}
    ...
    `}_renderBackgroundEffect(t){const e=this._getEffectClass(t);if(!e)return j``;if("effect-snow"===e){const t=this._getSnowIntensity();return j`
        <div class="weather-effects ${e} ${t}">
      ...
      `}return j`<div class="weather-effects ${e}"></div>`}_getEffectClass(t){const e=t?.toLowerCase()||"";return e.includes("rain")||e.includes("pouring")?"effect-rain":e.includes("snow")?"effect-snow":e.includes("fog")?"effect-fog":""}_getSnowIntensity(){const t=this._config.weather_entity?this.hass.states[this._config.weather_entity]:void 0;if(!t)return"";const e=Number(t.attributes?.precipitation)||0;return e>=4?"intensity-heavy":e<1?"intensity-light":""}_renderWeatherIcon(t,e){if(!t)return j`<span class="unavailable">No weather entity</span>`;const i=function(t,e){const i=t?.toLowerCase().replace(/-/g,"")||"cloudy",r=e?"day":"night",s=`${i}_${r}`;if(_t[s])return _t[s];const a=`${t}_${r}`;if(_t[a])return _t[a];const n={exceptional:"cloudy"}[i];if(n){const t=`${n}_${r}`;if(_t[t])return _t[t]}return'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><text x="32" y="40" text-anchor="middle" font-size="24">?</text></svg>'}(t,e);return j`${vt(i)}`}_renderSunTimes(){const t=this._config.sun_entity?this.hass.states[this._config.sun_entity]:void 0;if(!t)return j``;const e=t.attributes.next_rising,i=t.attributes.next_setting,r=t=>{if(!t)return"--:--";return new Date(t).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})};return j`
      <div class="sun-times">
        <div class="sun-time">
      ...
      <div class="forecast">
        ${i.map(t=>j`
          <div class="forecast-day">
            <div class="forecast-day-name">${(t=>{const e=new Date(t),i=new Date,r=new Date(i);return r.setDate(r.getDate()+1),e.toDateString()===i.toDateString()?"Today":e.toDateString()===r.toDateString()?"Tmrw":e.toLocaleDateString([],{weekday:"short"})})(t.datetime)}</div>
            <div class="forecast-icon">${kt[t.condition]||"❓"}</div>
    ...
    `}setConfig(t){this._config=t}_getEntityAttributes(t){if(!t||!this.hass?.states[t])return[];const e=this.hass.states[t],i=Object.keys(e.attributes||{}),r=["friendly_name","icon","entity_picture","supported_features","attribution","device_class","state_class","unit_of_measurement"];return i.filter(t=>!r.includes(t)).sort()}_getAttributeUnit(t,e){if(!t||!e||!this.hass?.states[t])return"";const i=this.hass.states[t],r=String(i.attributes.unit_of_measurement||""),s={temperature:r||"°F",apparent_temperature:r||"°F",dew_point:r||"°F",humidity:"%",pressure:"hPa",wind_speed:"mph",wind_gust_speed:"mph",visibility:"mi",precipitation:"in",precipitation_probability:"%",cloud_coverage:"%",uv_index:""};return void 0!==s[e]?s[e]:""}_getAttributeLabel(t){if(!t)return"";const e={temperature:"Temperature:",apparent_temperature:"Feels Like:",dew_point:"Dew Point:",humidity:"Humidity:",pressure:"Pressure:",wind_speed:"Wind:",wind_gust_speed:"Gusts:",wind_bearing:"Wind Direction:",visibility:"Visibility:",precipitation:"Precipitation:",precipitation_probability:"Precip Chance:",cloud_coverage:"Cloud Cover:",uv_index:"UV Index:",ozone:"Ozone:"};return void 0!==e[t]?e[t]:t.split("_").map(t=>t.charAt(0).toUpperCase()+t.slice(1)).join(" ")+":"}_renderAttributeSelect(t,e,i,r,s,a){const n=this._getEntityAttributes(t);return t&&0!==n.length?j`
      <ha-select .value=${i||""} .configValue=${e} .unitConfigValue=${s||""} .labelConfigValue=${a||""} .entityId=${t} @selected=${this._attributeChanged} @closed=${t=>t.stopPropagation()} fixedMenuPosition naturalMenuWidth>
        <mwc-list-item value="">Use State (no attribute)</mwc-list-item>
        ${n.map(t=>j`<mwc-list-item .value=${t}>${t}</mwc-list-item>`)}
      </ha-select>
    `:j`<ha-textfield .value=${i||""} .configValue=${e} @input=${this._valueChanged} placeholder=${r}></ha-textfield>`}render(){return this.hass&&this._config?j`
    ...
    `:j``}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target,i=e.configValue;if(!i)return;let r;if(r="checkbox"===e.type||"HA-SWITCH"===e.tagName?e.checked:"number"===e.type?e.value?Number(e.value):void 0:t.detail?.value??e.value,""===r||void 0===r){const t={...this._config};delete t[i],this._config=t}else this._config={...this._config,[i]:r};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_attributeChanged(t){if(!this._config||!this.hass)return;const e=t.target,{configValue:i,unitConfigValue:r,labelConfigValue:s,entityId:a,value:n}=e;if(!i)return;const o={...this._config};""===n||void 0===n?(delete o[i],r&&delete o[r],s&&delete o[s]):(o[i]=n,r&&(o[r]=this._getAttributeUnit(a,n)),s&&(o[s]=this._getAttributeLabel(n))),this._config=o,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_actionChanged(t){if(!this._config)return;const e=t.target,[i,r]=e.configValue.split("."),s={...this._config[i]||{},[r]:e.value};this._config={...this._config,[i]:s},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_actionPathChanged(t){if(!this._config)return;const e=t.target,[i,r]=e.configValue.split("."),s={...this._config[i]||{},[r]:e.value};this._config={...this._config,[i]:s},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_viewLayoutChanged(t){if(!this._config)return;const e=t.target.value,i={...this._config.view_layout};""===e||void 0===e?delete i["grid-area"]:i["grid-area"]=e;if(Object.keys(i).length>0)this._config={...this._config,view_layout:i};else{const t={...this._config};delete t.view_layout,this._config=t}this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}};t([pt({attribute:!1})],$t.prototype,"hass",void 0),t([ht()],$t.prototype,"_config",void 0),$t=t([dt("weather-card-editor")],$t),window.customCards=window.customCards||[],window.customCards.push({type:"weather-card",name:"Weather Card",description:"A customizable weather card with animated icons, forecast, and tap actions",preview:!0}),console.info("%c WEATHER-CARD %c v2.0.0 ","color: white; background: #3498db; font-weight: bold;","color: #3498db; background: white; font-weight: bold;");export{xt as WeatherCard,$t as WeatherCardEditor};
